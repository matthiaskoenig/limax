...
For larger features that you want to work on collaboratively with other limax
team members, you may consider to first request to join the limax developers
...
1. The pull request should include tests in the ``limax/test``
...
4. Someone from the @matthiaskoenig/limax-core team will review your work and guide
   you to a successful contribution.

Unit tests and benchmarks
-------------------------

limax uses `pytest <http://docs.pytest.org/en/latest/>`_ for its
...
Thank you very much for contributing to limax!
